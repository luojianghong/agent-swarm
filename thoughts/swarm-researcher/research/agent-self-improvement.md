...
The base prompt tells agents to "use `memory-search` to recall relevant context at session boot," but this is advisory. There is no mechanism to automatically inject relevant memories into the session context when a new task starts. The agent must manually search — and often doesn't.

**Impact:** Agents start most sessions cold, without leveraging their accumulated knowledge.
...
|----------|----------|--------|--------|
| 1 | **P1: Index Failed Tasks** | ~10 lines | Immediate: failure knowledge preserved |
| 2 | **P4: Better Session Summaries** | ~15 lines | Immediate: higher signal in memory |
| 3 | **P2: Architecture Self-Awareness** | ~20 lines | Immediate: agents can debug themselves |
| 4 | **P5: Post-Task Reflection** | ~20 lines | Medium-term: structured learning habit |
| 5 | **P3: Auto-Promote to Swarm Memory** | ~20 lines | Medium-term: cross-agent knowledge |
| 6 | **P7: Memory-Informed Prompting** | ~40 lines | High: agents start warm instead of cold |
| 7 | **P6: Lead-to-Worker Feedback** | ~80 lines | High: closes the lead→worker learning loop |
| 8 | **P8: Identity Version History** | ~120 lines | Medium: safety net + visibility |
| 9 | **P11: Scheduled Retrospectives** | ~150 lines | High: compound learning over time |
| 10 | **P9: Memory Consolidation** | ~300 lines | High: prevents memory degradation |
| 11 | **P10: Learning Dashboard** | ~500+ lines | Medium: visibility into swarm intelligence |
